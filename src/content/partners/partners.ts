...
const FINAL_CTA_SL: FinalCtaBlock = {
  ...
  secondaryCta: 'Raziščite našo strokovnost',
}

const selectedWorkEn: PartnersPageContent = {
  seo: {
    title:
...
const openSourceEn: PartnersPageContent = {
  seo: {
    title:
...
const clientsIndustriesEn: PartnersPageContent = {
  seo: {
    title:
...
const researchInnovationEn: PartnersPageContent = {
  seo: {
    title:
...
const selectedWorkSl: PartnersPageContent = {
  seo: {
    title:
...
const openSourceSl: PartnersPageContent = {
  seo: {
    title:
...
const clientsIndustriesSl: PartnersPageContent = {
  seo: {
    title:
...
const researchInnovationSl: PartnersPageContent = {
  seo: {
    title:
...
export const partnersPages: Record<
  PartnerSlug,
  Record<LanguageCode, PartnersPageContent>
> = {
