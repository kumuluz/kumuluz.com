...
const en: KumuluzPageContent = {
  ...
  hero: {
    ...
    body: [
      ...
      'Built on years of enterprise engineering experience, Kumuluz provides reusable foundations for modern digital systems — reducing complexity, accelerating delivery and supporting secure, scalable, governed innovation.',
      'Sunesis develops and delivers Kumuluz in real enterprise environments, combining product capability with architecture, integration and DevOps expertise.',
    ],
...
const sl: KumuluzPageContent = {
  ...
  hero: {
    ...
    body: [
      ...
      'Sunesis Kumuluz razvija in dostavlja v resničnih enterprise okoljih ter združuje produktne zmožnosti z arhitekturo, integracijo in DevOps strokovnostjo.',
    ],
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'KumuluzEE, open source mikrostoritveno ogrodje, ki ga je razvil Sunesis, je leta 2015 na konferenci JavaOne prejelo nagrado Java Duke’s Choice Award — eno najbolj prepoznavnih nagrad za inovacije v Java ekosistemu.',
