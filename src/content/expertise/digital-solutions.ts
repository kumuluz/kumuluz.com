...
const en: ExpertisePageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis designs and builds complete digital solutions — from backend systems and integrations to web, mobile and customer-facing applications — for organizations that need secure, scalable, business-critical software, combining senior engineering teams, enterprise architecture, API-first development and production delivery experience.',
      "Our digital solutions are built not just for today's applications but for tomorrow's AI-enabled enterprise — where services, APIs, workflows and business capabilities can be safely used by users, partners, systems and AI agents.",
    ],
...
const sl: ExpertisePageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis načrtuje in gradi celovite digitalne rešitve — od backend sistemov in integracij do spletnih, mobilnih in uporabniških aplikacij — za organizacije, ki potrebujejo varno, skalabilno in poslovno kritično programsko opremo. Pri tem združujemo izkušene razvojne ekipe, enterprise arhitekturo, API-first pristop in izkušnje s produkcijsko dostavo.',
      'Naše digitalne rešitve niso zasnovane le za današnje aplikacije, temveč za jutrišnje, z umetno inteligenco podprto podjetje — kjer storitve, API-je, workflowe in poslovne zmožnosti varno uporabljajo uporabniki, partnerji, sistemi in AI agenti.',
    ],
    primaryCta: 'Pogovorite se z našimi strokovnjaki',
    secondaryCta: 'Oglejte si reference',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        'Mnoge organizacije svojih sistemov ne potrebujejo zamenjati — potrebujejo jih razviti naprej. Sunesis pomaga uvesti API-je, modularne arhitekture, nove kanale, integracijske sloje, meje workflowov in cloud-native temelje brez motenj v poslovanju.',
