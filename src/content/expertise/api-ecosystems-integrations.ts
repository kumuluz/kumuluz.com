...
const sl: ExpertisePageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis organizacijam pomaga načrtovati, graditi in upravljati API ekosisteme, ki povezujejo interne ekipe, digitalne platforme, partnerske sisteme, enterprise aplikacije, workflow pogone in AI agente, pri čemer združuje API arhitekturo in upravljanje API-jev, integracijsko inženirstvo, Business API-je, dogodkovne vzorce in cloud-native dostavo.',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          label: 'Referenca',
          title: 'CUPID',
          text: 'Open source nabor orodij za interoperabilnost v energetiki pri LF Energy, ki omogoča povezovanje DER prek skupnih, nadzorovanih integracij.',
        },
        {
          label: 'Referenca',
          title: 'Kumuluz API',
