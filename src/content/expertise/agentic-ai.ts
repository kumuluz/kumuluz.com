...
const en: ExpertisePageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis designs and builds enterprise-grade AgenticAI solutions that go beyond conversation — helping organizations automate complete workflows, support employees and customers, connect knowledge with business systems and run AI safely in production.',
      ...
      'We help organizations move beyond isolated assistants with AI agents and digital agent teams that coordinate tasks across systems, automate end-to-end processes and involve people where judgment, approval or accountability is required.',
    ...
    secondaryCta: 'Explore KumuluzAI Platform',
...
const sl: ExpertisePageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis načrtuje in gradi enterprise AgenticAI rešitve, ki presegajo pogovor — organizacijam pomagajo avtomatizirati celotne workflowe, podpirati zaposlene in stranke, povezati znanje s poslovnimi sistemi in varno upravljati AI v produkciji.',
      ...
      'Organizacijam pomagamo preseči izolirane asistente z AI agenti in digitalnimi agentnimi ekipami, ki usklajujejo naloge med sistemi, avtomatizirajo procese od začetka do konca in vključijo ljudi tam, kjer so potrebni presoja, odobritev ali odgovornost.',
    ...
    secondaryCta: 'Raziščite KumuluzAI platformo',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          meta: 'Varen dostop do znanja, integracija API-jev, human-in-the-loop, regulirani workflowi',
        },
        {
