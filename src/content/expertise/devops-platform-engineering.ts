...
const en: ExpertisePageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis helps organizations build reliable DevOps and platform engineering foundations for secure, automated, production-grade software delivery — designing and improving CI/CD pipelines, GitOps workflows, infrastructure as code, Kubernetes and OpenShift platforms, cloud environments, security controls and observability.',
      'Our work supports enterprise digital platforms, API ecosystems, cloud-native applications, workflow automation platforms and AgenticAI solutions that must run reliably in real production environments.',
    ],
...
const sl: ExpertisePageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis organizacijam pomaga graditi zanesljive temelje za DevOps in platformni inženiring za varno, avtomatizirano in produkcijsko zrelo dostavo programske opreme — z načrtovanjem in izboljševanjem cevovodov CI/CD, GitOps workflowov, infrastrukture kot kode, platform Kubernetes in OpenShift, oblačnih okolij, varnostnih kontrol in opazljivosti.',
