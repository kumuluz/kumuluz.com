...
const en: CompanyPageContent = {
  ...
  hero: {
    ...
    body: [
      'Join a team of engineers, architects, AI experts and DevOps specialists building enterprise AgenticAI solutions, digital platforms, API ecosystems and cloud-native architectures.',
      'At Sunesis, you work on meaningful technology — from AI agents and digital banking platforms to Kubernetes environments, open-source projects, research initiatives and Kumuluz platforms.',
    ],
...
const sl: CompanyPageContent = {
  ...
  hero: {
    ...
    body: [
      'Pridružite se ekipi inženirjev, arhitektov, AI strokovnjakov in DevOps specialistov, ki razvijajo poslovne AgenticAI rešitve, digitalne platforme, API ekosisteme in cloud-native arhitekture.',
      'V Sunesisu delate s tehnologijo, ki ima pomen — od AI agentov in platform za digitalno bančništvo do okolij Kubernetes, open source projektov, raziskovalnih pobud in platform Kumuluz.',
    ],
  ...
  sections: [
    {
      ...
      body: [
        'Sunesis dela na projektih, kjer ima tehnologija resničen vpliv: poslovne digitalne platforme, avtomatizacija procesov z AI, varne integracije, sistemi javnega sektorja, API ekosistemi, cloud-native arhitekture, DevOps temelji, open source infrastruktura ter mednarodni raziskovalni in inovacijski projekti.',
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: 'Open source projekti',
          text: 'Prispevajte k open source digitalni infrastrukturi in projektom, povezanim z mednarodnimi ekosistemi, kot sta AgStack in LF Energy.',
        },
        {
      ...
      items: [
        {
          ...
          text: 'AgenticAI, cloud-native platforme, Kubernetes, API-ji, DevOps, integracije, open source projekti in raziskovalne pobude.',
        },
        {
        ...
        {
          title: 'Stik z open source in inovacijami',
          text: 'Poleg poslovne dostave lahko sodelujete pri open source pobudah in mednarodnih raziskovalnih projektih.',
        },
      ],
    },
    {
