...
const en: CompanyPageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis and the Kumuluz product family have been recognized for innovation in cloud-native technologies, Java microservices and enterprise digital platforms.',
      'Our awards, certifications and ecosystem contributions reflect our commitment to engineering excellence and enterprise technology delivery.',
    ],
...
const sl: CompanyPageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis in družina izdelkov Kumuluz sta prejela priznanja za inovativnost na področju cloud-native tehnologij, mikrostoritev v Javi in poslovnih digitalnih platform.',
      'Naše nagrade, certifikati in prispevki k ekosistemom odražajo predanost inženirski odličnosti in uvajanju poslovnih tehnologij.',
    ],
  ...
  sections: [
    {
      ...
      items: [
        {
          title: 'Java Duke’s Choice Award',
          text: 'KumuluzEE, open source ogrodje za mikrostoritve, ki ga je razvil Sunesis, je prejelo prestižno nagrado Java Duke’s Choice Award. Nagrada priznava inovativnost, ki temelji na tehnologiji Java, in jo je podjetje Oracle razglasilo na konferenci JavaOne v San Franciscu.',
    ...
    },
    {
      ...
      items: [
        {
          title: 'INATrace',
          text: 'Open source rešitev za sledljivost v kmetijskih dobavnih verigah, povezana z ekosistemom Linux Foundation AgStack.',
        },
        {
          title: 'CUPID',
          text: 'Open source nabor orodij za energetsko interoperabilnost, ki gostuje v ekosistemu LF Energy.',
        },
        {
          title: 'KumuluzEE',
          text: 'Nagrajeno open source ogrodje za mikrostoritve v Javi in del cloud-native dediščine Kumuluza.',
        },
      ],
    },
    {
      ...
      body: [
        ...
        'Danes družina izdelkov Kumuluz to smer nadaljuje s platformami in pospeševalniki za AgenticAI, digitalne platforme, API-je, Business API-je in crowdsensing. Težišče se je premaknilo od cloud-native mikrostoritev k ponovno uporabljivim temeljem poslovnih platform za AI agente, API ekosisteme, workflowe, digitalne storitve in z AI obogatene podatke.',
      ],
      quote:
    ...
    },
    {
      ...
      body: [
        'Sunesis združuje prepoznano inovativnost, certificirano znanje, prispevke k open source in praktične izkušnje z uvajanjem v podjetjih na področjih AgenticAI, digitalnih rešitev, API ekosistemov, cloud-native arhitektur in DevOps.',
      ],
      primaryCta: 'Pogovorite se z našimi strokovnjaki',
      secondaryCta: 'Raziščite naša področja',
    },
  ],
}
