...
const en: CompanyPageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis is a Slovenian software engineering company focused on enterprise AgenticAI, digital solutions, API ecosystems, cloud-native architectures, DevOps and Kumuluz platforms.',
      ...
      'We work with organizations that need more than development capacity — they need architecture, engineering depth, integration expertise, platform thinking and production experience.',
    ],
  ...
  sections: [
    ...
    },
    {
      ...
      primaryCta: 'Talk to our experts',
      secondaryCta: 'Explore our references',
    },
  ],
}
...
const sl: CompanyPageContent = {
  ...
  hero: {
    ...
    body: [
      'Sunesis je slovensko podjetje za inženiring programske opreme, osredotočeno na poslovni AgenticAI, digitalne rešitve, API ekosisteme, cloud-native arhitekture, DevOps in platforme Kumuluz.',
      ...
      'Sodelujemo z organizacijami, ki potrebujejo več kot le razvojne kapacitete — potrebujejo arhitekturo, inženirsko globino, integracijsko znanje, platformno razmišljanje in produkcijske izkušnje.',
    ],
    primaryCta: 'Pogovorite se z našimi strokovnjaki',
    secondaryCta: 'Raziščite naša področja ekspertize',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'Od KumuluzEE, nagrajenega open source ogrodja za mikrostoritve, do današnje platforme KumuluzAI Kumuluz predstavlja našo zavezanost gradnji tehnoloških temeljev, na katerih lahko gradijo drugi.',
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: 'Open source in ekosistemi Linux Foundation',
          text: 'Open source inženiring, ekosistemi fundacij, interoperabilnost, sledljivost v kmetijstvu in projekti energetske infrastrukture.',
        },
        {
    ...
    {
      type: 'prose',
      title: 'Miselnost open source in inovacij',
      body: [
        'Sunesis združuje poslovno dostavo s prispevkom k open source skupnosti in raziskovalno usmerjenimi inovacijami.',
        'Naše ekipe open source tehnologij ne le uporabljajo — pomagamo graditi open source rešitve, ki se lahko razvijajo skozi mednarodne skupnosti.',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          text: 'Sodelujemo z organizacijami v bančništvu, zavarovalništvu, javnem sektorju, energetiki, proizvodnji, blockchain infrastrukturi, open source ekosistemih in raziskavah.',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Posel in open source',
          title: 'Poslovne, open source in R&I izkušnje',
          text: 'Sodelujemo s poslovnimi strankami, open source ekosistemi, projekti Linux Foundation in mednarodnimi raziskovalnimi in inovacijskimi konzorciji.',
        },
      ],
    },
    {
      ...
      primaryCta: 'Pogovorite se z našimi strokovnjaki',
      secondaryCta: 'Raziščite naše reference',
    },
  ],
}
