...
export const quotes = [
  ...
  {
    quote:
      "Petrol is using Kumuluz as the backbone for its digital products. Kumuluz microservices are powering innovative mobile applications for digital, such as <a href='../../assets/images/quotes/://www.petrol.si/app-na-poti' target='_blank'>Na poti</a> and several mission critical backend systems, including Paymnet, Invocing, Cart, Order, Fulfilment and Product catalog. With Kumuluz we have been able to fast-track the development and shorten time-to-market. Kumuluz platform has become a valuable part of our digital transformation strategy.",
