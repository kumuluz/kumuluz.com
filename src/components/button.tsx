...
export function Button({
  ...
  const toneStyles = {
    primary: 'bg-accent-700 text-white hover:bg-neutral-900 transition-colors',
    'primary-dark':
      'bg-white text-neutral-900 hover:bg-neutral-200 transition-colors',
    secondary:
      'border border-neutral-200 bg-white text-neutral-800 hover:border-neutral-300 hover:bg-neutral-50 transition-colors',
    ghost:
