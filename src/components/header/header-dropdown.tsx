          ...
          <div className="mx-auto max-w-[120rem] px-4 py-10 sm:px-6">
            <div className="sm:px-8 lg:px-8">
              <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-center lg:gap-12">
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <ArrowRight
                            aria-hidden="true"
                            className="size-3.5 shrink-0 -translate-x-1 opacity-0 transition duration-300 group-hover:translate-x-0 group-hover:opacity-100"
                            strokeWidth={2.25}
                          />
                        </span>
                ...
                <motion.div
                  animate={{ opacity: 1, y: 0 }}
                  className="rounded-md bg-accent-50 p-6 lg:w-72 lg:shrink-0"
                  initial={{ opacity: 0, y: 12 }}
                ...
                >
                  ...
                  <motion.a
                    className="group mt-6 inline-flex items-center gap-2 text-sm font-semibold text-accent-700"
