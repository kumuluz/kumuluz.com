        ...
        return (
          <Fragment key={item.code}>
            ...
            <a
              ...
              className={`cursor-pointer rounded px-1.5 py-1 uppercase transition-opacity duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-400 ${
