...
export function NumberedCard({
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="pointer-events-none absolute right-3 top-1 select-none text-6xl font-black leading-none text-neutral-100 transition-colors duration-300 group-hover:text-accent-100"
      >
        {n}
      </span>
