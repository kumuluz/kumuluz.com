...
export function CheckCard({ item }: { item: CardItem }) {
  return (
    <motion.article
      ...
      variants={revealItem}
    >
      <span className="flex size-9 shrink-0 items-center justify-center rounded-lg bg-accent-50 text-accent-700 transition-colors duration-300 ease-out group-hover:bg-accent-600 group-hover:text-white">
