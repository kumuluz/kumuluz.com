...
export function CardB({
  ...
  return (
    ...
    >
      <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-md bg-accent-50 text-accent-700 transition group-hover:bg-accent-700 group-hover:text-white">
      ...
      <ul className="mt-5 space-y-2 text-sm font-medium text-neutral-700">
        {capabilities.map((capability) => (
          <li className="flex gap-2" key={capability}>
            <span className="mt-2 size-1.5 shrink-0 rounded-full bg-accent-600" />
