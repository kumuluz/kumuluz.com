...
type DevOpsPlatformEngineeringPageProps = {
  page: ExpertisePageContent
  language: LanguageCode
}

export function DevOpsPlatformEngineeringPage({
  page,
  language,
}: DevOpsPlatformEngineeringPageProps) {
  const contactHref = `/${language}/#contact`
  const referencesHref = `/${language}/references/`
