...
import { DigitalPlatformBackground } from '../../../../components/backgrounds/products/digital-platform'
    ...
    <div className="relative isolate overflow-hidden">
      ...
      <section className="relative px-5 pt-18 sm:px-6 lg:px-0">
        <div className="mx-auto grid max-w-[120rem] items-center gap-8 py-14 sm:py-16 lg:min-h-[calc(100svh-16rem)] lg:gap-8 lg:border-x lg:border-neutral-200 lg:px-28 lg:py-16 xl:px-36">
          <RevealGroup className="w-full max-w-[760px] lg:mx-auto lg:max-w-[960px] lg:text-center xl:max-w-[1080px]">
            <RevealItem>
            ...
            <RevealItem>
              <h1 className="mt-5 max-w-5xl text-4xl font-bold leading-[1.04] text-neutral-900 sm:text-[2.5rem] lg:mx-auto lg:text-[2.75rem]">
                {hero.title}
              </h1>
            </RevealItem>
