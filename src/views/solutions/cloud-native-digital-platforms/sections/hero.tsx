...
import { CloudNativeDigitalPlatformsBackground } from '../../../../components/backgrounds/solutions/cloud-native-digital-platforms'
...
export function SolutionHero({
  ...
  return (
    <div className="relative isolate overflow-hidden">
      <CloudNativeDigitalPlatformsBackground />
