...
import { CrowdsensingSmartCommunitiesBackground } from '../../../../components/backgrounds/solutions/crowdsensing-smart-communities'
...
export function SolutionHero({
  ...
  return (
    <div className="relative isolate overflow-hidden">
      <CrowdsensingSmartCommunitiesBackground />
      <section className="relative px-5 pt-18 sm:px-6 lg:px-0">
        <div className="mx-auto grid max-w-[120rem] items-center gap-8 py-14 sm:py-16 lg:min-h-[calc(100svh-16rem)] lg:gap-8 lg:border-x lg:border-neutral-200 lg:px-28 lg:py-16 xl:px-36">
          <RevealGroup className="w-full max-w-[680px] lg:mx-auto lg:max-w-[760px] lg:text-center xl:max-w-[820px]">
            <RevealItem>
            ...
            {hero.body.map((paragraph) => (
              <RevealItem key={paragraph}>
                <p className="mt-6 max-w-2xl text-base leading-7 text-neutral-600 sm:text-[1.0625rem] sm:leading-8 lg:mx-auto">
                  {paragraph}
                </p>
              </RevealItem>
            ))}
