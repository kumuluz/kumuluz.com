      ...
      <div className="km-index-page">
        ...
        <div className="container-fluid white-section">
          <div className="row align-items-center flex-column header">
            <div className="col-10 col-md-8 col-xl-5">
              <h1 className="text-center" dangerouslySetInnerHTML={{ __html: t("header.main-title") }} />
            </div>
        ...
        <div className="container-fluid competition-section">
          <div className="row justify-content-center">
            <div className="col-10 col-xl-4">
              <h2 className="text-center competition-title">{t("digitalLandscapeCompetition.title")}</h2>
            </div>
          </div>
          <div className="row justify-content-center">
            <div className="col-9 col-xl-6 competition-list">
              {digitalLandscapeCompetition(t).map((comp, index) => (
                <div className="competition-item" key={index}>
                  ...
                  <div className="competition-item-title">{comp.title}</div>
                  <div className="competition-item-content">{comp.content}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="container-fluid">
          ...
          <div className="row justify-content-center mt-5 mb-5">
            <div className="col-10 col-xl-6">
              <div className="row justify-content-center">
                <div className="col-10 col-md-5 awards-title">{t("awards.title")}:</div>
        ...
        <VideoPlayerComponent
          ref={(ref) => (this.bapisVideo = ref)}
          videoUrl={"https://player.vimeo.com/video/295128872"}
        />
        <VideoPlayerComponent
          ref={(ref) => (this.digitalVideo = ref)}
